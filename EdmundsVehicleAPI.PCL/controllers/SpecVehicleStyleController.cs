...
{
    public partial class SpecVehicleStyleController: BaseController
    {
        #region Singleton Pattern

        //private static variables for the singleton pattern
        private static object syncObject = new object();
        private static SpecVehicleStyleController instance = null;

        /// <summary>
        /// Singleton pattern implementation
        /// </summary>
        internal static SpecVehicleStyleController Instance
        {
            get
            {
                lock (syncObject)
                {
                    if (null == instance)
                    {
                        instance = new SpecVehicleStyleController();
                    }
                }
                return instance;
            }
                ...
                string view)
        {
            ...
            _queryBuilder.Append("/api/vehicle/v2/styles/{id}");
        ...
        /// <summary>
        /// Get vehicle styles by vehicle make and model niceNames and year.
        /// </summary>
        /// <param name="callback">Required parameter: The callback function that the JSON response will be wrapped in if desired</param>
        /// <param name="fmt">Required parameter: Response format (json only) (Acceptable values are: "json")</param>
        ...
        /// <param name="state">Required parameter: The state of the car style (Acceptable values are: "", "new", "used", "future")</param>
                ...
                string view = "")
        {
            ...
            //prepare query string for API call
            StringBuilder _queryBuilder = new StringBuilder(_baseUri);
            _queryBuilder.Append("/api/vehicle/v2/{makeNiceName}/{modelNiceName}/{year}/styles");
                ...
                string year)
        {
            ...
            //prepare query string for API call
            StringBuilder _queryBuilder = new StringBuilder(_baseUri);
            _queryBuilder.Append("/api/vehicle/v2/{makeNiceName}/{modelNiceName}/{year}/styles/count");
