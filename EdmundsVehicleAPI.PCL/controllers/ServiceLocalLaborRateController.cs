...
{
    public partial class ServiceLocalLaborRateController: BaseController
    {
        #region Singleton Pattern

        //private static variables for the singleton pattern
        private static object syncObject = new object();
        private static ServiceLocalLaborRateController instance = null;

        /// <summary>
        /// Singleton pattern implementation
        /// </summary>
        internal static ServiceLocalLaborRateController Instance
        {
            get
            {
                lock (syncObject)
                {
                    if (null == instance)
                    {
                        instance = new ServiceLocalLaborRateController();
                    }
                }
                return instance;
            }
        ...
        public async Task<dynamic> GetZiplaborrateAsync(
                string callback,
                string fmt,
                string zipcode)
        {
            ...
            _queryBuilder.Append("/v1/api/maintenance/ziplaborrate/{zipcode}");
