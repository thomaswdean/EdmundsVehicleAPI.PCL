...
{
    public partial class ContentEdmundsCarRatingsController: BaseController
    {
        #region Singleton Pattern

        //private static variables for the singleton pattern
        private static object syncObject = new object();
        private static ContentEdmundsCarRatingsController instance = null;

        /// <summary>
        /// Singleton pattern implementation
        /// </summary>
        internal static ContentEdmundsCarRatingsController Instance
        {
            get
            {
                lock (syncObject)
                {
                    if (null == instance)
                    {
                        instance = new ContentEdmundsCarRatingsController();
                    }
                }
                return instance;
            }
        ...
        /// <summary>
        /// Get vehicle ratings grade by make/model/year
        /// </summary>
        ...
        /// <param name="submodel">Required parameter: Vehicle submodel (i.e. sedan, suv, ...etc)</param>
        /// <param name="year">Required parameter: Vehicle four-digit year</param>
        /// <return>Returns the dynamic response from the API call</return>
        public async Task<dynamic> GetGradeAsync(
                string callback,
                string fmt,
                string makeNiceName,
                ...
                string year)
        {
            ...
            _queryBuilder.Append("/api/vehicle/v2/grade/{makeNiceName}/{modelNiceName}/{year}");
